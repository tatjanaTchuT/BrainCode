function NU = ContinuationNorec(J_,nu0,r_,mu0,tau_,delta,MaxIt)
    ...
    F(1) = X(1)-getnu(sigmaX(1),tau(1),J(1,1)*X(1)*C(1,1)+J(1,2)*X(2)*C(1,2)+X(3),ff);
    F(2) = X(2)-getnu(sigmaX(2),tau(2),J(2,1)*X(1)*C(2,1)+J(2,2)*X(2)*C(2,2)+r*X(3),ff);
