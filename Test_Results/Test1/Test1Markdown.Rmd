...
data_ConnectivityMatrix_10 <- Load_Connectivity(folder_name,1,0);
...
The last two figures show the strength of the synaptic connections. The synaptic weights are set to be equally split between weak connections shown in red (0.13 mV/spike) and strong connections shown in green (0.23mV/spike).
```{r,echo=FALSE}
...
hist(data_JpotMatrix_10,breaks = (0:12)/40,xlab = "",main = "Synaptic Weight", freq = TRUE)
