...
void ExponentialCurrentSynapse::advectSpikers (std::vector<double>& currents, long spiker){
...
std::vector<double> ExponentialCurrentSynapse::GetSynapticState(int pre_neuron)
{
