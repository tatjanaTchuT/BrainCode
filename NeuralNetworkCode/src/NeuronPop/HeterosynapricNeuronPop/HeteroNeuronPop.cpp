...
std::shared_ptr<SynapseExt> HeteroNeuronPop::allocateNewSynapse(unsigned long neuronId, int branchId) {
    return this->morphology[neuronId]->allocateNewSynapse(branchId);
}
